...
export default function FormShelterAd() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.duration) newErrors.duration = "مدة الايواء مطلوبة";
    if (!formData.accommodation_type)
      newErrors.accommodation_type = "نوع  الايواء مطلوب";
    ...
    try {
      ...
      body.append("accommodation_type", formData.accommodation_type);
      ...
      const res = await api.post("/provider/ads/accommodation", body);
          ...
          <form onSubmit={handleSubmit}>
            <div className="row">
              ...
              <div className="col-lg-8">
                ...
                {/* Box 2 - Shelter Details */}
                <div className="box-form">
                  <div className="row">
                    <div className="col-md-6">
                      <div className="select-group">
                        <label htmlFor="accommodationType">نوع الايواء</label>
                        <div className="select-box">
                          <select
                          ...
                          >
                            ...
                            <option value="single">فردى</option>
                            <option value="group">جماعى</option>
                          </select>
                          <i className="fa-solid fa-caret-down arrow"></i>
                        </div>
                  ...
                  <div className="col-md-12">
                    <div className="input-group">
                      <label htmlFor="price">سعر الايواء</label>
